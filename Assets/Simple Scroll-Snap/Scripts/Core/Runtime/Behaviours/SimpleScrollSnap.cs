...
namespace DanielLochner.Assets.SimpleScrollSnap
{
    ...
    public class SimpleScrollSnap : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler, IPointerDownHandler, IPointerUpHandler
    {
        ...
        private void Setup()
        {
            ...
            prevAnchoredPosition = -Panels[startingPanel].anchoredPosition + offset;
            prevAnchoredPosition.y = Content.anchoredPosition.y;
            Content.anchoredPosition = prevAnchoredPosition;
        ...
        private void SnapToPanel()
        {
            ...
            if(Mathf.Abs(Content.anchoredPosition.x - targetPosition.x) > 0.05f)
            {
